package com.example.reactcassandra.model
...
data class EmployeeDto(@get:NotBlank val name: String,
    ...
    // domainのマッピング
    companion object {
        fun fromDto(dto: EmployeeDto) = Employee(UUID.randomUUID().toString()
                                                            , dto.name
                                                            , dto.age
                                                            , dto.department
                                                            , dto.salary)
        fun toDto(employee: Employee) = EmployeeDto(employee.name
                                                                , employee.age
                                                                , employee.department
                                                                , employee.salary)
    }
